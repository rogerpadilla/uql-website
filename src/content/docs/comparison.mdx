...
Across these operations, UQL is on average **~2.1x** faster than the next fastest tool (July 2026 run: TypeORM 1.0, MikroORM 7.1, UQL 0.9).
...
| :--- | :--- | ---: | ---: |
| SELECT (complex) | Knex (247K) | 612K ops/s | **2.5x** |
| SELECT (1 field) | Sequelize (3,052K) | 3,472K ops/s | **1.1x** |
| SELECT + SORT + LIMIT | Knex (614K) | 1,190K ops/s | **1.9x** |
| AGGREGATE | Sequelize (410K) | 1,431K ops/s | **3.5x** |

### Writes (mutations)

| Operation | Next fastest | UQL | Advantage |
| :--- | :--- | ---: | ---: |
| INSERT (10 rows) | Knex (477K) | 565K ops/s | **1.2x** |
| UPDATE | Kysely (812K) | 1,772K ops/s | **2.2x** |
| UPSERT | Knex (443K) | 656K ops/s | **1.5x** |
| DELETE | Sequelize (1,361K) | 3,525K ops/s | **2.6x** |
