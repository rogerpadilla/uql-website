...
| Multi-tenancy / RLS (non-bypassable) | ❌ | 🔌 | 🔌 | ❌ | ✅ |
| Lifecycle hooks | ❌ | ✅ | 🔌 | ✅ | ✅ |
...
⁴ TypeORM soft-deletes and restores (`restore()`); MikroORM/Prisma need a plugin or extension. UQL's `security` filters are non-bypassable and fail closed on missing context; MikroORM's filters and Prisma's extensions/DB-native RLS are the closest equivalents.
</small>
