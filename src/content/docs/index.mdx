...
- **Fast by design.** Fastest in [all 8 categories](/comparison#performance) of our [open benchmark](https://github.com/rogerpadilla/ts-orm-benchmark): on average ~2.1× faster than the runner-up, reaching 3.5M ops/s on simple SELECTs and DELETEs.
